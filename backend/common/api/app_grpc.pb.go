...
const (
	MediaService_Upload_FullMethodName = "/api.MediaService/Upload"
)
...
type MediaServiceClient interface {
	Upload(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*Media, error)
}
...
func (c *mediaServiceClient) Upload(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*Media, error) {
...
type MediaServiceServer interface {
	Upload(context.Context, *UploadRequest) (*Media, error)
...
func (UnimplementedMediaServiceServer) Upload(context.Context, *UploadRequest) (*Media, error) {
